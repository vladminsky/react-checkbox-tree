/*! react-checkbox-tree - v1.0.0 | 2017 */
...
var _TreeNode = __webpack_require__(27);

var _TreeNode2 = _interopRequireDefault(_TreeNode);

var _nodeShape = __webpack_require__(10);
...
var CheckboxTree = function (_React$Component) {
    ...
    _createClass(CheckboxTree, [{
        ...
        value: function componentWillReceiveProps(_ref) {
            ...
            if (!(0, _lodash.isEqual)(this.props.nodes, nodes)) {
        ...
        value: function renderTreeNodes(nodes) {
            ...
            var _props2 = this.props,
                ...
                singleValueOnly = _props2.singleValueOnly,
                allowFolderSelector = _props2.allowFolderSelector;
...
CheckboxTree.propTypes = {
    ...
    allowFolderSelector: _propTypes2.default.bool,
    ...
    singleValueOnly: _propTypes2.default.bool,
...
var isValid = __webpack_require__(25);
...
var TreeNode = function (_React$Component) {
    ...
    _createClass(TreeNode, [{
        ...
        value: function renderCheckboxIcon(singleValueOnly) {
            var suffix = singleValueOnly ? 'radio' : 'check';
            var genClass = function genClass(head, tail) {
                return head + tail;
            };
            if (this.props.checked === 0) {
                return _react2.default.createElement('span', { className: genClass('rct-icon rct-icon-un', suffix) });
            }

            if (this.props.checked === 1) {
                return _react2.default.createElement('span', { className: genClass('rct-icon rct-icon-', suffix) });
            }

            return _react2.default.createElement('span', { className: genClass('rct-icon rct-icon-half-', suffix) });
        }
    }, {
        key: 'renderNodeIcon',
        ...
        value: function render() {
            var _props = this.props,
                ...
                value = _props.value,
                singleValueOnly = _props.singleValueOnly,
                allowFolderSelector = _props.allowFolderSelector;

            var inputId = treeId + '-' + value;
            var isFolder = this.hasChildren();
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        !isFolder || isFolder && allowFolderSelector ? _react2.default.createElement(
                            'span',
                            { className: 'rct-checkbox' },
                            this.renderCheckboxIcon(singleValueOnly)
                        ) : null,
...
TreeNode.propTypes = {
    allowFolderSelector: _propTypes2.default.bool.isRequired,
    ...
    singleValueOnly: _propTypes2.default.bool.isRequired,
